...
/**
 * Class that combines several group systems into one. The {@link #isInGroup(Player, String)} method
 * will return true if any of the group systems returns true.
 */
public final class CombinedGroupSystem extends GroupSystem {
  ...
  /**
   * Adds a new group system. After calling this method, the {@link #isInGroup(Player, String)}
   * method on this object is guaranteed to return true if the {@link #isInGroup(Player, String)} on
   * the given group system returns true too. too.
   *
   * @param system The group system, may not be null.
   */
