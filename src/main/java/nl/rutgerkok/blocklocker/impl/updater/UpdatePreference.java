...
public enum UpdatePreference {
  ...
  /**
   * Parses the update preference from the string. The string is {@link String#trim() trimmed},
   * uppercased and spaces are replaced with underscores. Then {@link #valueOf(String)} is called,
   * and the result is returned as an {@link Optional}.
   *
   ...
   *
   * @return True if updates should be downloaded and installed automatically, false otherwise.
   */
