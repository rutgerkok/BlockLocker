...
public final class Updater {
  ...
  /**
   * Notifies admins of the server of an updated version of the plugin. Can be called from any
   * thread.
   *
   ...
   *
   * @throws IllegalStateException If this method was called earlier.
   */
  ...
  private void notifyUpdateAvailable(UpdateCheckResult result) throws IOException {
    ...
    if (minecraftVersion.isEmpty()
        || result.getMinecraftVersions().containsAll(ImmutableSet.of(minecraftVersion.get()))) {
      ...
      plugin
          ...
          .log(
              ...
              "Error during update check"
                  + " (you can disable automatic updates in the config file)",
              e);
