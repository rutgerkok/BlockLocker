...
/**
 * Implements a secret sign entry on top of NBT tags (using
...
public final class NbtSecretSignEntry implements SecretSignEntry {
    ...
    private static class SecretSignTagType implements PersistentDataType<PersistentDataContainer, NbtSecretSignEntry> {
        ...
        @Override
        public NbtSecretSignEntry fromPrimitive(PersistentDataContainer primitive,
        ...
        @Override
        public PersistentDataContainer toPrimitive(NbtSecretSignEntry complex,
                PersistentDataAdapterContext context) {
            return complex.data;
        }
    ...
    private static final WeakReference<Plugin> PLUGIN = new WeakReference<>(
            JavaPlugin.getProvidingPlugin(NbtSecretSignEntry.class));
