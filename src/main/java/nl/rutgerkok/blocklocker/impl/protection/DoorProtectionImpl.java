...
public final class DoorProtectionImpl extends AbstractProtection implements DoorProtection {
   ...
   */
  public static Protection fromDoorWithSign(
      ProtectionSign sign, BlockFinder blockFinder, CompleteDoor door) {
   ...
   * @param blockFinder The block finder.
   * @param door The door that is protected.
   * @return The protection.
   */
  public static Protection fromDoorWithSigns(
      Collection<ProtectionSign> signs, BlockFinder blockFinder, CompleteDoor door) {
