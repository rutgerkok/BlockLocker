...
public final class AttachedProtectionImpl extends AbstractProtection implements AttachedProtection {
   ...
   *
   * @param sign A hint. If it is a main sign, the owner can easily be looked up, speeding up {@link
   *     #getOwner()}.
   * @param blockFinder The block finder.
   * @param protectionBlock The door.
   * @return The door protection object.
   */
  public static Protection fromBlockWithSign(
      ProtectionSign sign, BlockFinder blockFinder, Block protectionBlock) {
   ...
   *
   * @param signs All signs of the protection. Collection may not be empty.
   * @param blockFinder The block finder.
   * @param trapDoor The door that is protected.
   * @return The protection.
   */
  public static Protection fromBlockWithSigns(
      Collection<ProtectionSign> signs, BlockFinder blockFinder, Block trapDoor) {
  ...
  private AttachedProtectionImpl(
      Collection<ProtectionSign> signs, BlockFinder blockFinder, Block trapDoor) {
    super(signs);
