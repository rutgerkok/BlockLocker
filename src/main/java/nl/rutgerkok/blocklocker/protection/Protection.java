...
public interface Protection {
  ...
  enum SoundCondition {
    ...
    NEVER,
    /**
     * Only play a sound for doors that the Minecraft client doesn't automatically play a sound for
     * a player opens it.
     */
    AUTOMATIC,
    /** Always play a sound. */
  ...
  /**
   * Gets the allowed profiles in this protection. Allowed profiles can place/take items and open
   * doors, but cannot break the protection. This list includes the {@link #getOwner() owner}.
   *
  ...
  /**
   * Gets the location of the protection. Returns one of the blocks in the protection (if there are
   * multiple blocks), and not one of the signs.
   *
   * @return The location.
   */
  ...
  /**
   * Gets the amount of seconds the door should stay open, before closing automatically. If no
   * amount of seconds was specified on the door, -1 is returned.
   *
  ...
  /**
   * Gets the owner of this protection. The owner is the only one allowed to destroy this
   * protection. All protections have an owner, unless they have been corrupted by for example a
   * world editor.
   *
   * @return The owner.
   * @see #isOwner(Profile)
  ...
  /**
   * Gets the display name of the owner of the protection. If {@link #getOwner()} is absent, "?" is
   * returned.
   *
  ...
  /**
   * Gets all signs used in this protection. Low-level method, {@link #getAllowed()} is preferred.
   * Example usage is changing the contents on the sign.
   *
  ...
  /**
   * Gets whether this protection is expired. As protection is expired when the {@link #getOwner()
   * owner profile} is considered {@link Profile#isExpired(Date) expired}.
   *
  ...
  /**
   * Gets whether the door is currently opened. If only parts of the door are open, the result of
