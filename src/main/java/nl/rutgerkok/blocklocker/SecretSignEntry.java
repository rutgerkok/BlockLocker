...
/**
 * Used to store secret extra data on a sign. This class represents a single entry, so it can for
 * example store one player.
 */
public interface SecretSignEntry {
   ...
   *
   * @param key The key, must only contain [a-z_].
