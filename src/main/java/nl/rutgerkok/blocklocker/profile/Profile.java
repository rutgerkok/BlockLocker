...
/**
 * Represents a profile. A profile is usually a player, but it may also be a whole group or
 * something abstract like "Redstone".
 */
public interface Profile {
   ...
   *
   * @param signEntry The entry to save to.
   */
  void getSaveObject(SecretSignEntry signEntry);

  /**
   * Gets whether this profile includes another profile. For example, "[Everyone]" includes all
   * other profiles, and "jeb_" includes everyone with the name jeb_.
   *
   ...
   *
   * @param cutoffDate The cutoff date: there must be activity for this profile after the given
   *     date, or else it's considered expired.
