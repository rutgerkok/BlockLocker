...
public interface ProfileFactory {
  ...
  /**
   * Gets the profile represented by [Everyone] on a sign. Allows everyone else to access the sign.
   *
   * @return The profile.
   */
   ...
   *
   * @param name The name.
   * @param uuid The uuid. When absent, comparisons between other {@link PlayerProfile} the plugin
   *     may try to fetch this UUID at any time based on the name. {@code new UUID(0,0)}
   * @return The profile.
   */
