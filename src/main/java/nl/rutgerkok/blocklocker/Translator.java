...
public abstract class Translator {
  ...
  public enum Translation {
    ...
    PROTECTION_LIMIT_REACHED,
    PROTECTION_LIMIT_TEAM_REACHED,
    PROTECTION_LIMIT_INFO,
    TAG_EVERYONE,
    TAG_MORE_USERS,
    TAG_PRIVATE,
    TAG_REDSTONE,
  ...
  /**
   * Returns the translation with the given key. If no such translation exists, the key is returned.
   *
  ...
  /**
   * Same as {@link #getAll(Translation)}, but with {@link ChatColor#stripColor(String)} applied.
   *
   * @param key The key of the translation.
   * @return A list of all possible translations, or the key (in a list) if not found.
   */
  ...
  /**
   * Same as {@link #get(Translation)}, but with {@link ChatColor#stripColor(String)} applied.
   *
   * @param key The key of the translation.
   * @return The translation, or the key if not found.
   */
   ...
   *
   * @param player The player (or console) to the send the message to.
   * @param translation The message to send.
   */
   ...
   * @param player The player (or console) to the send the message to.
   * @param translation The message to send.
   * @param parameters Replacements for the message. {0} will be replaced by the first parameter,
   *     etc.
   */
  public final void sendMessage(
      CommandSender player, Translation translation, String... parameters) {
