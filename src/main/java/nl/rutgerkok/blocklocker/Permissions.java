...
public final class Permissions {
  ...
  /**
   * Gets the permission node that a player needs to have to be considered part of a group.
   *
  ...
  public static Permission getGroupNode(String groupName) {
    return new Permission(
        GROUP_PREFIX + groupName.toLowerCase(Locale.ROOT), PermissionDefault.FALSE);
  }
